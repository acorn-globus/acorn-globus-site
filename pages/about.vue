<template>
  <div>
    ...
    <!-- ===== ORIGIN STORY ===== -->
    <section class="section-redesign origin">
      <div class="container-redesign">
    ...
    <!-- ===== TEAM / FOUNDERS ===== -->
    <section class="section-redesign team-section">
      <div class="container-redesign">
    ...
    <!-- ===== PARTNERSHIPS ===== -->
    <section class="section-redesign partnerships">
      <div class="container-redesign">
        <div class="section-header">
          <span class="text-label">Partnerships, not projects</span>
          <h2 class="text-display-sm" style="margin-top: 16px;">We don't just deliver and disappear. We stay.</h2>
        </div>
          ...
          <div class="partnership-story-grid">
            ...
            <div>
              ...
              <div class="partnership-stats">
                ...
                <div>
                  <div class="partnership-stat-value">3 Mo</div>
        ...
        <div class="partnership-closing">
          <p class="text-body-lg" style="font-style: italic;">In an industry where most agencies finish the work and move on, we walk together. That's not a strategy. That's who we are.</p>
        </div>
      </div>
    </section>

    <!-- ===== VALUES / PRINCIPLES ===== -->
    <section class="section-redesign values-section">
      <div class="container-redesign">
        <div class="section-header">
          <span class="text-label">What we believe</span>
          <h2 class="text-display-sm" style="margin-top: 16px;">Principles, not just processes.</h2>
        </div>
        <div class="values-grid">
          ...
          <div class="value-card">
            ...
            <h3>Honest guidance over easy agreements</h3>
            <p>We'll tell you what you need to hear, not what you want to hear. If your timeline is aggressive, we'll say so. If a feature can wait, we'll recommend waiting. Your success matters more than our invoice.</p>
          </div>
          <div class="value-card">
            <div class="value-icon">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#0058bd" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
            </div>
            <h3>Built to hand over, built to last</h3>
            <p>Your code. Your product. Your freedom. We write clean, documented code that your future in-house team can pick up and run with. Zero lock-in. Though most clients choose to stay.</p>
          </div>
          <div class="value-card">
            <div class="value-icon">
...
.logo-bar {
  padding: 48px 0;
  background: var(--surface);
  border-top: 1px solid rgba(194, 198, 213, 0.12);
}
.logo-bar-label {
  text-align: center;
  font-size: 14px;
