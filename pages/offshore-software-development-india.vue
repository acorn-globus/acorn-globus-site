<template>
  <div>
    ...
    <!-- WHY OFFSHORE TO INDIA (answer-first) -->
      ...
      <div class="container-redesign">
        ...
        <div class="value-grid" style="margin-top: 48px;">
          ...
          <div class="value-card">
            ...
            <p>India is one of the world's largest sources of professional software engineers, across modern web, mobile, backend, cloud, and data stacks. Depth means we can match specific skills to your product, and scale the team as it grows.</p>
          </div>
          <div class="value-card">
            <h3>Vetted, not a marketplace</h3>
            <p>You don't sift through anonymous resumes. We propose specific, vetted engineers, you interview them directly, and a two-week embedded trial proves the fit before any long-term commitment.</p>
          </div>
          <div class="value-card">
        ...
        <div class="process-steps" style="margin-top: 48px;">
          ...
          <div class="process-step">
            ...
            <div>
              ...
              <p>Once the fit is confirmed, we keep building together. Scale the team up or down, or add complementary skills, as your product evolves.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="section-redesign" style="background: var(--surface);">
      <div class="container-redesign">
        <div style="max-width: 760px;">
          <h2 class="text-display-sm">Ways to Work With an Offshore Team</h2>
          <p class="text-body-lg" style="margin-top: 16px;">Offshoring isn't one thing. Pick the model that fits where your product is today.</p>
        </div>
        <div class="feature-cards-grid" style="margin-top: 48px;">
          ...
          <NuxtLink to="/services/mvp-development/" class="feature-card" style="text-decoration: none;">
            ...
            <p>Get a demoable, real product in weeks, not quarters. Ideal for founders validating an idea on an offshore budget before scaling the team.</p>
          </NuxtLink>
    ...
    <section class="section-redesign">
      <div class="container-redesign">
        <div style="max-width: 760px;">
          <h2 class="text-display-sm">Skills You Can Offshore to Us</h2>
          <p class="text-body-lg" style="margin-top: 16px;">We build across the modern web, mobile, and backend stack. Hire for a single skill or a full cross-functional team.</p>
        </div>
        <div class="related-links" style="margin-top: 32px;">
          <NuxtLink to="/hire-react-developer/" class="related-link">React</NuxtLink>
          <NuxtLink to="/hire-react-native-developer/" class="related-link">React Native</NuxtLink>
          <NuxtLink to="/hire-vuejs-developer/" class="related-link">Vue.js</NuxtLink>
          <NuxtLink to="/hire-nuxt-developer/" class="related-link">Nuxt</NuxtLink>
          <NuxtLink to="/hire-angular-developer/" class="related-link">Angular</NuxtLink>
          <NuxtLink to="/hire-nodejs-developer/" class="related-link">Node.js</NuxtLink>
          <NuxtLink to="/hire-python-developer/" class="related-link">Python</NuxtLink>
          <NuxtLink to="/hire-django-developer/" class="related-link">Django</NuxtLink>
          <NuxtLink to="/hire-rails-developer/" class="related-link">Rails</NuxtLink>
          <NuxtLink to="/hire-flutter-developer/" class="related-link">Flutter</NuxtLink>
          <NuxtLink to="/hire-dotnet-developer/" class="related-link">.NET</NuxtLink>
        </div>
      </div>
    </section>
    ...
    <section class="section-redesign" style="background: var(--surface);">
      <div class="container-redesign">
        <div style="max-width: 760px;">
          <h2 class="text-display-sm">Partnerships That Prove the Model</h2>
          <p class="text-body-lg" style="margin-top: 16px;">Offshoring works when the relationship is built to last. Ours are.</p>
        </div>
        <div class="feature-cards-grid" style="margin-top: 48px;">
          ...
          <NuxtLink to="/guides/it-staff-augmentation/" class="feature-card" style="text-decoration: none;">
            ...
            <p>How augmentation works, when it beats in-house hiring, and how to embed an external or offshore engineer well.</p>
          </NuxtLink>
...
const faqs = [
  ...
  },
  {
    ...
    answer: "We guarantee live overlap with your working hours rather than relying on pure async handoffs. India's day overlaps naturally with UK and European mornings and afternoons and with the US morning, and we flex our engineers' hours so you get shared time for standups, reviews, and quick questions every working day."
  },
  {
  ...
  },
  {
    ...
    answer: "We propose specific, vetted engineers matched to your stack and domain, and you interview them directly. Then a two-week embedded trial lets you see real output on your codebase before any long-term commitment. If the fit isn't right, you walk away with no cost for the trial period."
  },
  {
...
useHead({
  link: [
    { rel: 'canonical', href: 'https://acornglobus.com/offshore-software-development-india/' },
  ],
})

useServiceSchema({
  name: 'Offshore Software Development in India',
  description: 'Offshore software development company in India for teams in the US, UK, Canada, and Australia. Vetted engineers, real timezone overlap, direct communication, and a 2-week embedded trial.',
  url: '/offshore-software-development-india',
})

useFaqSchema(faqs.map(f => ({ question: f.question, answer: f.answer })))

useBreadcrumbSchema([
  { name: 'Offshore Software Development in India', path: '/offshore-software-development-india/' },
])
</script>

<style scoped>
/* ===== VALUE GRID (why offshore to India) ===== */
.value-grid {
  display: grid;
