<template>
  <div>
    ...
    <!-- THE HONEST STATE OF AI DEVELOPMENT (pain / bias-undercut) -->
      ...
      <div class="container-redesign">
        ...
        <div class="feature-cards-grid" style="margin-top: 48px;">
          ...
          <div class="feature-card">
            ...
            <p>Text and content generation wired into your product's real workflows, with the guardrails and evaluation that keep the output usable in production.</p>
          </div>
          <div class="feature-card">
    ...
    <section class="section-redesign" style="background: var(--surface);">
      <div class="container-redesign">
        <div class="section-header" style="max-width: 720px;">
          <h2 class="text-display-sm">Proof, not promises</h2>
    ...
    <!-- WE DON'T SELL CHEAPER (speed + quality) -->
    <section class="section-redesign">
      <div class="container-redesign">
        <div style="max-width: 720px;">
    ...
    <!-- YOU MIGHT NOT NEED US IF (honesty block) -->
    <section class="section-redesign" style="background: var(--surface);">
      <div class="container-redesign">
      ...
      <div class="container-redesign">
        ...
        <div class="process-steps">
          <div class="process-step">
            ...
            <div>
              <h3>Scope the real use case</h3>
              <p>We start by pressure-testing whether AI is even the right answer, and where it actually creates value. If a simpler solution wins, we'll tell you.</p>
            </div>
          </div>
          <div class="process-step">
          ...
          <div class="process-step">
            ...
            <div>
              <h3>Eval &amp; guardrails</h3>
              <p>We measure whether the AI actually does the job, and add the guardrails that keep it safe and predictable when real users hit it.</p>
            </div>
          </div>
          <div class="process-step">
        ...
        <div class="pull-quote" style="margin-top: 48px;">
          <p>The line between a working AI feature and a fragile one is whether the team knows how to code as well as how to drive the AI.</p>
        </div>
      </div>
    </section>
    ...
    <section class="section-redesign" style="background: var(--surface);">
      <div class="container-redesign">
        <div class="section-header">
          <h2 class="text-display-sm">Tech We Build With</h2>
        </div>
        <div class="tech-stack-grid">
          ...
          <div class="tech-group">
            ...
            <div class="tech-tags">
              ...
              <span class="tech-tag">Evaluation &amp; guardrails</span>
            </div>
          </div>
        </div>
      </div>
