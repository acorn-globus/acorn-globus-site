        ...
        <div class="container-redesign">
          ...
          <div class="service-offerings-grid">
            ...
            <div class="service-offering-card">
              ...
              <p class="text-body" style="margin-top: 12px;">AI agents, generative AI, LLM and RAG features, and AI wired into an app you already have. We run AI in our own SaaS and operate our own AI agents, so this is real capability, not a pitch. Need agents specifically? See <NuxtLink to="/services/ai-agent-development/" style="color: var(--brand-blue); font-weight: 500;">AI Agent Development</NuxtLink>. Built it with AI and it's breaking? We do <NuxtLink to="/services/ai-app-rescue/" style="color: var(--brand-blue); font-weight: 500;">AI App Rescue</NuxtLink> too.</p>
              <ul class="check-list">
                ...
                <li>Shipped to production and monitored, which is where most AI projects fail</li>
              </ul>
              <div class="proof-point">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#34A853" stroke-width="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
              ...
              <div class="card-ctas">
                ...
                <NuxtLink to="/services/ai-development/" class="btn-text">Learn more about AI Development <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><polyline points="9 18 15 12 9 6"/></svg></NuxtLink>
              </div>
            </div>
          </div>
        </div>
