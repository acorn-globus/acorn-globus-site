<template>
  <div>
    ...
    <div class="project-meta">
      <div class="container-redesign">
        <div class="project-meta-inner">
          <div class="meta-item"><div class="meta-label">Client</div><div class="meta-value">PerformLine</div></div>
          <div class="meta-item"><div class="meta-label">Engagement</div><div class="meta-value">Resource Augmentation</div></div>
          <div class="meta-item"><div class="meta-label">Duration</div><div class="meta-value">2+ Years</div></div>
          <div class="meta-item"><div class="meta-label">Status</div><div class="meta-value">Ongoing</div></div>
        </div>
      </div>
    </div>
    ...
    <section style="padding-top: 80px; padding-bottom: 80px;">
      <div class="container-redesign">
        <div class="stats-row" style="margin-top: 0; padding-top: 0; border-top: none;">
          <div class="stat"><span class="stat-value">1 to 8+</span><span class="stat-label">Engineers</span></div>
          <div class="stat"><span class="stat-value">2+</span><span class="stat-label">Years Together</span></div>
          <div class="stat"><span class="stat-value">5</span><span class="stat-label">Disciplines Covered</span></div>
          <div class="stat"><span class="stat-value">Ongoing</span><span class="stat-label">Partnership Status</span></div>
        </div>
      </div>
    </section>
      ...
      <div class="container-redesign">
        <div style="max-width: 720px;">
          ...
          <ul class="check-list" style="margin-top: 24px;">
            ...
            <li>Same tools, same standups, same Slack channels</li>
            <li>The test: can this person actually become part of our team?</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <!-- TESTIMONIAL 1 -->
    <section class="testimonial-block" style="background: var(--surface);">
      <div class="container-redesign">
        <div class="testimonial-card">
          ...
          <blockquote>"Acorn Globus is my go-to team when I need a trusted partner to execute any front-end project. They are super attentive, communicate effectively, and accurately manage your expectations for their time and involvement."</blockquote>
          <div class="testimonial-author" style="display:flex;align-items:center;gap:12px;">
            <img src="/images/testimonials/bogdan.jpeg" alt="Bogdan Arsenie" style="width:48px;height:48px;border-radius:50%;object-fit:cover;" loading="lazy">
            <div>
              <div class="name">Bogdan Arsenie</div>
              <div class="role">CTO, PerformLine</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="section-redesign" style="background: var(--surface);">
      <div class="container-redesign">
        <div style="max-width: 720px;">
          <h2 class="text-display-sm">Five Disciplines, One Team</h2>
          <p class="text-body-lg" style="margin-top: 20px;">Over two years, we grew from a single engineer to a cross-functional squad covering every layer of the stack.</p>
        </div>
        <div class="discipline-cards">
          ...
          <div class="discipline-card">
            <div class="discipline-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" stroke-width="2" stroke-linecap="round"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>
            </div>
            <h3>Frontend Engineering</h3>
            <p>Complex UI components, performance optimization, and user-facing features that compliance teams interact with every day.</p>
          </div>
          <div class="discipline-card">
            <div class="discipline-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" stroke-width="2" stroke-linecap="round"><rect x="2" y="2" width="20" height="8" rx="2"/><rect x="2" y="14" width="20" height="8" rx="2"/><line x1="6" y1="6" x2="6.01" y2="6"/><line x1="6" y1="18" x2="6.01" y2="18"/></svg>
            </div>
            <h3>DevOps</h3>
            <p>Infrastructure management, CI/CD pipelines, deployment automation, and keeping the platform reliable at scale.</p>
          </div>
          <div class="discipline-card">
            <div class="discipline-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" stroke-width="2" stroke-linecap="round"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"/><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"/></svg>
            </div>
            <h3>Data Engineering</h3>
            <p>Data pipelines, ETL processes, and analytics infrastructure that power PerformLine's compliance monitoring insights.</p>
          </div>
          <div class="discipline-card">
            <div class="discipline-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" stroke-width="2" stroke-linecap="round"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>
            </div>
            <h3>Quality Assurance</h3>
            <p>Comprehensive testing strategies, automated test suites, and quality gates ensuring every release meets the bar for regulated industries.</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container-redesign">
        ...
        <div class="insight-cards">
          ...
          <div class="insight-card">
            ...
            <p>When PerformLine needed frontend specialists, we brought frontend engineers. When they needed DevOps, we brought DevOps. We adapted to what the product demanded.</p>
          </div>
          <div class="insight-card">
            <h3>We Stayed</h3>
      ...
      <div class="container-redesign">
        ...
        <div class="timeline" style="max-width: 720px;">
          <div class="timeline-step">
            ...
            <p>Day one. One engineer embedded into PerformLine's team. Same tools, same standups, same Slack channels. The goal was simple: ship production code and prove we belong.</p>
          </div>
          <div class="timeline-step">
...
<style scoped>
/* Case study hero */
.cs-hero { padding-top: 140px; padding-bottom: 80px; }
.cs-badge { display: inline-flex; align-items: center; gap: 6px; background: rgba(52, 168, 83, 0.1); color: var(--success); font-size: 13px; font-weight: 600; padding: 6px 14px; border-radius: var(--radius-pill); margin-top: 24px; }
.cs-badge::before { content: ''; width: 8px; height: 8px; background: var(--success); border-radius: 50%; }

/* Project meta bar */
.project-meta { background: var(--surface); border-top: 1px solid rgba(194, 198, 213, 0.15); border-bottom: 1px solid rgba(194, 198, 213, 0.15); }
.project-meta-inner { display: grid; grid-template-columns: repeat(4, 1fr); gap: 32px; padding: 32px 0; }
.meta-item { font-size: 14px; }
.meta-label { font-weight: 600; color: var(--on-surface); margin-bottom: 4px; }
.meta-value { color: var(--text-secondary); }

/* Testimonial block */
.testimonial-block { padding: 64px 0; }
.testimonial-card { max-width: 720px; margin: 0 auto; text-align: center; }
.testimonial-card blockquote { font-size: 22px; line-height: 1.6; color: var(--on-surface); font-style: italic; font-weight: 500; letter-spacing: -0.01em; }
.testimonial-card .quote-icon { width: 48px; height: 48px; margin: 0 auto 24px; color: var(--primary-fixed-dim); }
.testimonial-author { margin-top: 24px; }
.testimonial-author .name { font-size: 16px; font-weight: 600; color: var(--on-surface); }
.testimonial-author .role { font-size: 14px; color: var(--text-secondary); margin-top: 2px; }

/* Discipline cards */
.discipline-cards { display: grid; grid-template-columns: repeat(3, 1fr); gap: 24px; margin-top: 48px; }
.discipline-card { background: var(--surface-container-lowest); border-radius: var(--radius-card); padding: 32px; transition: all var(--duration-normal) var(--ease-premium); }
.discipline-card:hover { box-shadow: var(--shadow-hover); transform: translateY(-2px); }
.discipline-icon { width: 48px; height: 48px; background: var(--primary-fixed-dim); border-radius: 12px; display: flex; align-items: center; justify-content: center; margin-bottom: 16px; }
.discipline-card h3 { font-size: 18px; font-weight: 700; color: var(--on-surface); margin-bottom: 8px; }
.discipline-card p { font-size: 15px; line-height: 1.6; color: var(--on-surface-variant); }

/* What-made-this-work cards */
.insight-cards { display: grid; grid-template-columns: repeat(3, 1fr); gap: 24px; margin-top: 48px; }
.insight-card { background: var(--surface-container-lowest); border-radius: var(--radius-card); padding: 32px; border-top: 3px solid var(--primary-fixed-dim); transition: all var(--duration-normal) var(--ease-premium); }
.insight-card:hover { box-shadow: var(--shadow-hover); transform: translateY(-2px); }
.insight-card h3 { font-size: 18px; font-weight: 700; color: var(--on-surface); margin-bottom: 8px; }
.insight-card p { font-size: 15px; line-height: 1.6; color: var(--on-surface-variant); }

/* Timeline */
.timeline { margin-top: 48px; position: relative; padding-left: 48px; }
.timeline::before { content: ''; position: absolute; left: 19px; top: 0; bottom: 0; width: 2px; background: var(--primary-fixed-dim); }
.timeline-step { position: relative; padding-bottom: 48px; }
.timeline-step:last-child { padding-bottom: 0; }
.timeline-dot { position: absolute; left: -48px; top: 4px; width: 40px; height: 40px; background: var(--primary-fixed-dim); border-radius: 10px; display: flex; align-items: center; justify-content: center; font-size: 16px; font-weight: 800; color: var(--primary); z-index: 1; }
.timeline-step h3 { font-size: 20px; font-weight: 700; color: var(--on-surface); margin-bottom: 8px; }
.timeline-step p { font-size: 16px; line-height: 1.6; color: var(--on-surface-variant); max-width: 600px; }

/* CTA section */
.cta-section { text-align: center; }
.cta-buttons { display: flex; align-items: center; justify-content: center; gap: 20px; margin-top: 36px; flex-wrap: wrap; }

/* Responsive */
@media (max-width: 1024px) {
  .project-meta-inner { grid-template-columns: repeat(2, 1fr); }
  .discipline-cards { grid-template-columns: 1fr 1fr; }
  .insight-cards { grid-template-columns: 1fr; }
}
@media (max-width: 640px) {
  .cs-hero { padding-top: 100px; }
  .project-meta-inner { grid-template-columns: 1fr 1fr; gap: 20px; }
  .discipline-cards { grid-template-columns: 1fr; }
