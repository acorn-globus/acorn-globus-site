...
const designs = [
  ...
  },
  {
    ...
    description: 'Clean and modern dashboard design for a project management SaaS platform with complex data visualization.',
    category: 'UI/UX',
    categoryId: 'uiux',
  ...
  },
  {
    ...
    description: 'Comprehensive platform for event planning with ticket booking, venue management, and analytics.',
    category: 'Web Design',
    categoryId: 'web',
  ...
  {
    id: 6,
    title: 'Healthcare Mobile Interface',
    description: 'Patient-focused mobile app design for telemedicine with appointment booking and health tracking.',
    category: 'Mobile Apps',
    categoryId: 'mobile',
