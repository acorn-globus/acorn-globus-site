    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div class="border-t border-gray-300 mt-12 pt-8">
        <div class="flex flex-col md:flex-row justify-between items-center text-sm">
          <p class="text-gray-600">&copy; 2025 Acorn Globus. All rights reserved.</p>
          <div class="mt-4 md:mt-0">
            <NuxtLink to="/v3/privacy-policy" class="text-gray-600 hover:text-purple-600 transition-colors">
              Privacy Policy
            </NuxtLink>
          </div>
        </div>
