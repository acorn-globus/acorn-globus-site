...
watch(
  ...
  async () => {
    if (selectedElement.value && pdfBox.value) {
      ...
      textContent.value = pdfBox.value.getSelectedElement(selectedElement.value)?.content || ''
...
const toggleUnderline = () => {
  const newDecoration = textDecoration.value === 'underline' ? 'none' : 'underline'
...
<template>
  <div v-if="selectedElement" class="properties-container">
    <div class="property-container">
      <p>Text Content</p>
      <input type="text" v-model="textContent" @change="updateContent" placeholder="Enter text" />
    </div>

    <div class="property-container">
      <p>Font</p>
      <div>
        <select v-model="selectedFont" @change="updateProperty('fontFamily', selectedFont)">
    ...
    <div class="property-container">
      ...
      <div class="icon-button-group">
        <button :class="{ active: fontWeight === 'bold' }" @click="toggleBold">B</button>
        <button :class="{ active: fontStyle === 'italic' }" @click="toggleItalic">I</button>
        <button :class="{ active: textDecoration === 'underline' }" @click="toggleUnderline">
          U
        </button>
      </div>
    </div>
    ...
    <div class="property-container">
      <div class="property-container">
        <p>Text</p>
        <input type="color" v-model="textColor" @change="updateProperty('color', textColor)" />
      </div>
