  ...
  <section class="bg__primary relative overflow-hidden" id="hero">
    ...
    <div class="py-20 relative z-10">
      <div class="container__wrapper">
        <div
          class="flex flex-col items-center text-center gap-8 max-w-4xl mx-auto"
        >
          <h1 class="hero__heading">Web Application Development Services</h1>

          <p class="hero__subheading">
            Scale your business to new heights with Acorn Globus. Our dedicated
            web app development services seamlessly grow your user base, no
            matter the size or type of your company. Create purpose based custom
